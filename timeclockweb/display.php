...
while ($row=mysql_fetch_array($result)) {
    ...
    $date = date($datefmt, $display_stamp);
		...
		echo " 		      <td nowrap width=5% align=right style='padding-left:10px;'><a style='font-size:11px;color:#27408b;'	
				    href='$current_page?sortcolumn=tstamp&sortdirection=$sortnewdirection'>Employee ID</a></td>\n";
        ...
        echo "		      <td nowrap width 5% align=left style='padding-left:10px;padding-right:10px;font-size:11px;color:27408b;
    ...
    echo "		  <td nowrap align=right width=7% bgcolor='$row_color' style='padding-right10px;'>".$row["employid"]."</td>\n";
