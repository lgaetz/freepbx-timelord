...
echo "                <th class=table_heading nowrap width=5% align=left>EmpID</th>\n";
...
$query = "select empfullname, displayname, employid, email, groups, office, admin, reports, time_admin, disabled from ".$db_prefix."employees
          order by empfullname";
...
echo "		      <td class=table_rows nowrap width=5%>&nbsp;".$row['employid']."</td>\n";
